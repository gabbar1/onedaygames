                      ...
                      Row(crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          Row(children: [
                            ...
                            SizedBox(width: 20,),
                            Text((sendMoney.recieverList[snap].phone==null ? "  "+user_nt_found: sendMoney.recieverList[snap].phone),
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Row(children: [
                      ...
                      SizedBox(width: 20,),
                      Text(( send.username==null ? "  "+user_nt_found: send.username),
                          style : TextStyle(fontSize: 15.0,
                              fontWeight:FontWeight.bold,color: Colors.black )),],)
                  ],),
              ],
